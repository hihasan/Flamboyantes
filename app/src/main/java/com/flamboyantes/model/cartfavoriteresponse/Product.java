...
import com.flamboyantes.model.products.LocalizedName;
...
public class Product {
    ...
    @SerializedName("product_downloads_thismonth")
    @Expose
    private Integer productDownloadsThismonth;
    @SerializedName("product_download_total")
    @Expose
    private Integer productDownloadTotal;
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    public Object getShowOnHomePage() {
        return showOnHomePage;
    }

    public void setShowOnHomePage(Object showOnHomePage) {
    ...
    public Integer getProductDownloadsThismonth() {
        return productDownloadsThismonth;
    }

    public void setProductDownloadsThismonth(Integer productDownloadsThismonth) {
        this.productDownloadsThismonth = productDownloadsThismonth;
    }

    public Integer getProductDownloadTotal() {
        return productDownloadTotal;
    }

    public void setProductDownloadTotal(Integer productDownloadTotal) {
        this.productDownloadTotal = productDownloadTotal;
    }
